...
| 平台 | 主频频率 | 计算方式 | 时间 |
| :---| :--- | :--- | :---|
| STM32 | 72M | 软件计算 | 95.5us |
| STM32 | 72M | 采样加软件计算 | 105.5us |
| STM32 | 48M | 软件计算 | 114.5us |
| STM32 | 48M | 采样加软件计算 | 127.5us |
| CW32 | 96M | 软件计算 | 379us |
| CW32 | 96M | 硬件计算 | 329us |
| CW32 | 96M | 采样加软件计算 | 385us |
| CW32 | 96M | 采样加硬件计算 | 334us |
| CW32 | 48M | 软件计算 | 456us |
| CW32 | 48M | 硬件计算 | 400us |
| CW32 | 48M | 采样加软件计算 | 463us |
| CW32 | 48M | 采样加硬件计算 | 406us |
